...
*/
					...
					//b=prop[k][j];
					//printf("%d\n",bluu);
					*(uint32_t*)&iter->map[off] = ((k>90)*(k<500)*(j>310)*(j<400)*30+bsett << 16) | i/20 << 8 | (k<cx+CURSOR_SIZE/2)*(k>cx-CURSOR_SIZE/2)*(j<cy+CURSOR_SIZE/2)*(j>cy-CURSOR_SIZE/2)*90; //(int)(100*sin(off/900000*(cy/120));
